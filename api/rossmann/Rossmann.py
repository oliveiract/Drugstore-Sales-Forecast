...
class Rossmann(object):
    ...
    def data_preparation(self,df5):
        ...
        cols_selected = ['store','promo_week','store_type','assortment',
                 'competition_distance', 'competition_open_since_month',
                 'competition_open_since_year','promo_month',
                 'promo_month_since_week','promo_month_since_year',
                 'competition_time_month','promo_month_time_week',
